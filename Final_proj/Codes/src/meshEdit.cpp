...
namespace CGL {
  ...
  {
    for( vector<PointCloudNode>::iterator n = pointCloudNodes.begin(); n != pointCloudNodes.end(); n++) renderPointCloud( n->point_cloud );
  ...
  void MeshEdit::mesh_up_sample_butterfly()
  {
    HalfedgeMesh* mesh;
    ...
    resampler.upsample_butterfly( *mesh );
