...
namespace CGL {
   ...
   */
   ...
   class MeshEdit : public Renderer {
      ...
      void init_point_cloud(PointCloud& pointcloud); // NEWWW
      ...
      // Rendering functions.
      void renderPointCloud ( PointCloud& point_cloud); // NEWWW
      void renderMesh   ( HalfedgeMesh& mesh ); // NEWWW
