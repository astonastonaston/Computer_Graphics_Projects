...
class BVHAccel : public Aggregate {
 public:
  ...
  // static bool mycmp(Primitive * i, Primitive * j);
  // void qsort(const std::vector<Primitive *> &_primitives);
  ...
  // void BVHAccel::__construct_bvh(std::vector<Primitive *>::iterator start,
  ...
  // bool intersect_bbox(const Ray& r, BVHNode *node) const;
